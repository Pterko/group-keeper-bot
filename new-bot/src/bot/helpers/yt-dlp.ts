  ...
  return new Promise((resolve, reject) => {
    ...
    let ytDlpEventEmitter = ytDlp
      .exec([
          url,
          '-f',
          'bestvideo[codec=h264][height<=1080][ext=mp4]+(bestaudio[format_note*=original][ext=m4a]/bestaudio[ext=m4a])/best[codec=h264][height<=1080][ext=mp4]/best[height<=1080]',
