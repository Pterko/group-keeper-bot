...
<b>Что я умею:</b>
- Скачивать короткие видео из Twitter, Youtube и Instagram: просто отправь ссылку в чат, или же введи ссылку через инлайн (начав своё сообщение с @GroupKeeperBot, а потом введя ссылку на видео)
